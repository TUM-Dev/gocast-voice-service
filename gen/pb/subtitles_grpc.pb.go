...
const (
	SubtitleGenerator_Generate_FullMethodName = "/live.voice.v1.SubtitleGenerator/Generate"
)
...
func (c *subtitleGeneratorClient) Generate(ctx context.Context, in *GenerateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SubtitleGenerator_Generate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSubtitleGeneratorServer must be embedded to have
...
func (UnimplementedSubtitleGeneratorServer) testEmbeddedByValue()                           {}
...
func RegisterSubtitleGeneratorServer(s grpc.ServiceRegistrar, srv SubtitleGeneratorServer) {
	// If the following call pancis, it indicates UnimplementedSubtitleGeneratorServer was
...
func _SubtitleGenerator_Generate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SubtitleGenerator_Generate_FullMethodName,
	}
...
const (
	SubtitleReceiver_Receive_FullMethodName = "/live.voice.v1.SubtitleReceiver/Receive"
)
...
func (c *subtitleReceiverClient) Receive(ctx context.Context, in *ReceiveRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SubtitleReceiver_Receive_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSubtitleReceiverServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedSubtitleReceiverServer) testEmbeddedByValue()                          {}
...
func RegisterSubtitleReceiverServer(s grpc.ServiceRegistrar, srv SubtitleReceiverServer) {
	// If the following call pancis, it indicates UnimplementedSubtitleReceiverServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _SubtitleReceiver_Receive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SubtitleReceiver_Receive_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
